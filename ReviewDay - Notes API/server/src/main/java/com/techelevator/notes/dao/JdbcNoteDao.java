...
@Component
public class JdbcNoteDao implements NotesDao{
    ...
    public Note updateNote(Note note) {
        String sql = "UPDATE note SET user_id = ?, created_date = ?, todo_date = ?, message = ? WHERE note_id = ?;";
        jdbcTemplate.update(sql, note.getUserId(), note.getCreatedDate(), note.getTodoDate(), note.getMessage(), note.getId());
